...
// RandIntn 获取一个 0-maxInt 之间的随机整数, 不包含maxInt
func RandIntn(maxInt int) int {
	return rand.New(rand.NewSource(time.Now().UnixNano())).Intn(maxInt)
}

// DivisionN 非4舍5入，保留2位数的除法，division
...
// RangeRandFloat64 获取给定两个值的中间的随机数
