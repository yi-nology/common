...
func TestUnmarshalStructOptionalDepends(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(xstrings.Rand(), func(t *testing.T) {
			m := map[string]interface{}{
				"name": "kevin",
				"address": map[string]interface{}{
					"city": "shanghai",
	...
	t.Run("map of struct", func(t *testing.T) {
		m := map[string]interface{}{
			"Ids": map[string]interface{}{
				"foo": map[string]interface{}{"Name": "foo"},
			},
		}
		var v struct {
			Ids map[string]struct {
...
func TestUnmarshalSlice(t *testing.T) {
	...
	t.Run("slice with type mismatch", func(t *testing.T) {
		...
		assert.Error(t, NewUnmarshaler(jsonTagKey).Unmarshal([]interface{}{1, 2}, &v))
	})

	t.Run("slice", func(t *testing.T) {
		var v []int
		ast := assert.New(t)
		if ast.NoError(NewUnmarshaler(jsonTagKey).Unmarshal([]interface{}{1, 2}, &v)) {
			ast.Equal(2, len(v))
			ast.Equal(1, v[0])
			ast.Equal(2, v[1])
		}
...
func TestUnmarshalAnonymousOptionalRequiredProvided(t *testing.T) {
	...
	if assert.NoError(t, NewUnmarshaler("json").Unmarshal(m, &b)) {
		assert.Equal(t, "interface{}thing", b.Value)
	}
}
...
func TestUnmarshalWrappedObject(t *testing.T) {
	...
	var b Bar
	if assert.NoError(t, NewUnmarshaler("json").Unmarshal(m, &b)) {
		assert.Equal(t, "interface{}thing", b.Inner.Value)
	}
}
...
func TestUnmarshalWrappedObjectOptional(t *testing.T) {
	...
	m := map[string]interface{}{
		"Name": "interface{}thing",
	}

	var b Bar
	if assert.NoError(t, NewUnmarshaler("json").Unmarshal(m, &b)) {
		assert.Equal(t, "interface{}thing", b.Name)
	}
}
...
func TestUnmarshalNestedMap(t *testing.T) {
	t.Run("nested map", func(t *testing.T) {
		var c struct {
			Anything map[string]map[string]string `json:"interface{}thing"`
		}
		m := map[string]interface{}{
			"interface{}thing": map[string]map[string]interface{}{
				"inner": {
					"id":   "1",
					"name": "interface{}",
				},
	...
	t.Run("nested map with slice element", func(t *testing.T) {
		var c struct {
			Anything map[string][]string `json:"interface{}thing"`
		}
		m := map[string]interface{}{
			"interface{}thing": map[string][]interface{}{
				"inner": {
					"id",
					"name",
				},
...
func TestUnmarshalNestedMapMismatch(t *testing.T) {
	var c struct {
		Anything map[string]map[string]map[string]string `json:"interface{}thing"`
	}
	m := map[string]interface{}{
		"interface{}thing": map[string]map[string]interface{}{
			"inner": {
...
func TestUnmarshalNestedMapSimpleTypeMatch(t *testing.T) {
	...
	m := map[string]interface{}{
		"interface{}thing": map[string]string{
			"id":   "1",
			"name": "interface{}",
		},
	}
...
func TestFillDefaultUnmarshal(t *testing.T) {
	...
	t.Run("handling struct", func(t *testing.T) {
		...
		var st2 St2
		err := fillDefaultUnmarshal.Unmarshal(map[string]interface{}{}, &st2)
		assert.NoError(t, err)
...
func Test_UnmarshalMap(t *testing.T) {
	...
	t.Run("map from string with error", func(t *testing.T) {
		type Customer struct {
			Names map[string]interface{} `key:"names,string"`
		}
...
func (m mockValuerWithParent) Value(key string) (interface{}, bool) {
	return m.value, m.ok
}
