...
func NewTemplateCard() *TemplateCard {
	return &TemplateCard{}
}

func (t *TemplateCard) SetCardType(s string) *TemplateCard {
	switch s {
	case TemplateCardTypeText:
		t.CardType = TemplateCardTypeText
	case TemplateCardTypeNews:
		t.CardType = TemplateCardTypeNews
	}
	return t
}

func (t *TemplateCard) SetSource(s *TemplateCardSource) *TemplateCard {
	t.Source = s
	return t
}

func (t *TemplateCard) SetMainTitle(s TemplateCardMainTitle) *TemplateCard {
	t.MainTitle = s
	return t
}

func (t *TemplateCard) SetCardImage(s *TemplateCardImage) *TemplateCard {
	t.CardImage = s
	return t
}

func (t *TemplateCard) SetImageTextArea(s *TemplateCardImageTextArea) *TemplateCard {
	t.ImageTextArea = s
	return t
}

func (t *TemplateCard) SetEmphasisContent(s *TemplateCardEmphasisContent) *TemplateCard {
	t.EmphasisContent = s
	return t
}

func (t *TemplateCard) SetQuoteArea(s *TemplateCardQuoteArea) *TemplateCard {
	t.QuoteArea = s
	return t
}

func (t *TemplateCard) SetSubTitleText(s string) *TemplateCard {
	t.SubTitleText = &s
	return t
}

func (t *TemplateCard) SetHorizontalContentList(s []*TemplateCardHorizontalContent) *TemplateCard {
	t.HorizontalContentList = s
	return t
}

func (t *TemplateCard) SetJumpList(s []*TemplateCardJump) *TemplateCard {
	t.JumpList = s
	return t
}

func (t *TemplateCard) SetCardAction(s TemplateCardAction) *TemplateCard {
	t.CardAction = s
	return t
}
